...
if __name__ == "__main__":
    ...
    # --- Choose a Dataset ---
    mimic_dataset = MIMIC('/home/hoang/Datasets/MIMIC/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='Vocabulary/mimic_unigram_1000.model')    
    dataset = NLMCXR('/home/chayan/IU-XRay/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='Vocabulary/mimic_unigram_1000.model') 
