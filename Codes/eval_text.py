...
from models_swin import Classifier, TNN
...
#TEXT_FILE = 'outputs/x_{}_ClsGen_DeiT-384_MaxView2_NumLabel114_History_Hyp.txt'.format(DATASET_NAME)
#LABEL_FILE = 'outputs/x_{}_ClsGen_DeiT-384_MaxView2_NumLabel114_History_Lbl.txt'.format(DATASET_NAME)

TEXT_FILE = 'outputs/x_{}_ClsGen_Swin_MaxView2_NumLabel114_History_Hyp.txt'.format(DATASET_NAME)
LABEL_FILE = 'outputs/x_{}_ClsGen_Swin_MaxView2_NumLabel114_History_Lbl.txt'.format(DATASET_NAME)

#TEXT_FILE = 'outputs/x_{}_ClsGenInt_DenseNet121_MaxView2_NumLabel114_History_Hyp.txt'.format(DATASET_NAME)
#LABEL_FILE = 'outputs/x_{}_ClsGenInt_DenseNet121_MaxView2_NumLabel114_History_Lbl.txt'.format(DATASET_NAME)
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='/home/chayan/CGI_Net/Vocabulary/mimic_unigram_5000.model', max_len=1000)
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='Vocabulary/nlmcxr_unigram_1000.model', max_len=1000)
    ...
    # --- Choose a Model ---
    if MODEL_NAME == 'Transformer':
        NUM_EMBEDS = 384   ## for DenseNet 256
        NUM_HEADS = 12  ## for DenseNet 8
        FWD_DIM = 384  ## for DenseNet 256
        NUM_LAYERS = 1
        DROPOUT = 0.1
    ...
    checkpoint_path_from = 'checkpoints_Swin/{}_{}_{}.pt'.format(DATASET_NAME,MODEL_NAME,COMMENT)
